        ...
        >
          <div className="spread">
            <a onClick={this.cameraOn}>
              {openCamera ? (
                <RiCameraOffLine size="40" className="logo-endcall" />
              ) : (
                <RiCameraLine size="40" className="logo-endcall" />
              )}
            </a>
            &emsp;&emsp;&emsp;&emsp;
            <a onClick={this.muteOn}>
              {openMic ? (
                <FiMicOff size="40" className="logo-endcall" />
              ) : (
                <FiMic size="40" className="logo-endcall" />
              )}
            </a>
            &emsp;&emsp;&emsp;&emsp;
            <a onClick={this.alienOn}>
              {openFilter ? (
                <RiAliensLine size="40" className="logo-endcall" />
              ) : (
                <MdFace size="40" className="logo-endcall" />
              )}
            </a>
          </div>
        </Box>
